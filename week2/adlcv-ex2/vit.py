...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # # Print size of keys,queries,values,attention
...
class ViT(nn.Module):
    def __init__(self, image_size, channels, patch_size, embed_dim, num_heads, num_layers,
        ...
        self.to_patch_embedding = nn.Sequential(
            Rearrange('B C (num_patches_h patch_h) (num_patches_w patch_w) -> B (num_patches_h num_patches_w) (C patch_h patch_w)', patch_h=patch_h, patch_w=patch_w),
